...
export let lprStatics = [
  ...
  export let noteStatics = {
    ...
    genMsg: "Data not shown for those with unknown country of birth/origin and for countries where total activity count was less than 10 people. <br/> dw = Data withheld to limit disclosures, per government sources. <br/><br/> Source code: <a href='https://github.com/braxtonex/immigration-visualizer'>github.com/braxtonex/immigration-visualizer</a>."
  };
